...
class ControllableTimer extends Thread {
     ...
     * @param remoteView represents the PiccrossView object which will be passed to constructor to set to class variable view.
     */
    ...
    public void run() {
        while (getStatus() != TERMINATE) {
            ...
            EventQueue.invokeLater(new Runnable() {
                @Override
                public void run() {
                    PiccrossView.getTimeElapsed(++elapsed); //This call updates your UI.
                }
            }); //End EventQueue
