...
public class PiccrossNetworkModalVC extends JDialog
{
    ...
    **/
    public PiccrossNetworkModalVC  (JFrame mainView)
    {
        ...
        portInput = new JComboBox<String>(new String[] {"","61001","32150","42150","52150"});
        ...
        outerPanel.setBorder(BorderFactory.createMatteBorder(5,5,5,5,new Color(255, 204, 102)));
    ...
    */
    ...
    /**
     * Setter to set the nameInput.
     * @param name User's name.  Will be at least three characters long.
     */
    public void setName(String name){nameInput.setText(name);}
